...
app.layout = html.Div(
    [
        ...
        html.Div([
            ...
            html.Span("CHANGEX DASHBOARD", className='app-title-niall'),

            html.Div(
                html.Img(src='https://downloads.intercomcdn.com/i/o/27789/390c63013f4cc195681804e7/logo-white.png',height="65%")
        ...
        html.Div([
            ...
            dcc.Tabs(
                ...
                children=[
                    dcc.Tab(label="Fund Performance", value="opportunities_tab"),
                    dcc.Tab(label="Demographics", value="leads_tab"),
                    dcc.Tab(id="cases_tab",label="Impact Dashboard", value="cases_tab"),
                ],
